...
def _montar_tabela_posicao(_sb, tabela: str, status_alvo: str) -> pd.DataFrame:
...
def render_posicao_clientes():
    ...
    st.markdown("**Cash-in**")
    tabela_in = _montar_tabela_posicao(sb, "cashin", "PROCESSED")
    if tabela_in.empty:
    ...
    tabela_out = _montar_tabela_posicao(sb, "cashout", "SUCCESSFULLY PROCESSED")
    if tabela_out.empty:
