...
def app_principal():
    ...
    # UPLOAD
        ...
        st.caption("Aceita: Extrato Asaas (.xlsx), Extrato BB PIX - conta 1160-6 (.xlsx), Extrato BB ADM - conta 1547-4 (.xlsx)")
        extratos_bancarios = st.file_uploader(
            "Selecione os extratos bancários (.xlsx)",
            type=["xlsx"],
            accept_multiple_files=True,
            key="extratos_bancarios",
            help="Extrato Asaas completo, BB PIX (1160-6) e BB ADM (1547-4)"
        )
