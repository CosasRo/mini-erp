            ...
            if not df_fech.empty:
                ...
                for _, row in df_fech.iterrows():
                    ...
                    for i, col_key in enumerate(COLUNAS_FECHAMENTO):
                        ...
                        # Badge colorido acima do selectbox
                        if val_atual == "REALIZADO":
                            ...
                            cor = "#888"; fundo = "#2a2a3a"

                        if val_atual:
                            cols[i+1].markdown(
                                f'<div style="background:{fundo};color:{cor};border-radius:6px;padding:2px 8px;font-size:0.7rem;font-weight:600;text-align:center;margin-bottom:2px;">{val_atual}</div>',
                                unsafe_allow_html=True
                            )
